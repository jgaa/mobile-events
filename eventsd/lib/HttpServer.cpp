...
ostream& operator << (ostream& o, const eventsd::lib::Request::Type& t) {
...
//            res.result(401);
//            res.base().set(http::field::server, "eventsd "s + EVENTSD_VERSION);
...
//        }
        ...
        // TODO: Set the request.owner field based on the authentication.
        request.owner = "nobody";
        ...
        request.sse_send = [&](string_view sse) {
            ...
            if (!sse_initialized) {
               ...
               res.set(http::field::server, "eventsd "s + EVENTSD_VERSION);
